...
import { createBooking } from "../../store/bookings/bookingEffects/bookingEffects";
...
function BookingPage() {
  ...
  const bookingCreated = useAppSelector(selectBookingCreated);
  const lastBookingId = useAppSelector(selectLastBookingId);
  ...
  }, [passengers, classPrice, selectedClass]);
  ...
  const handleRemovePassenger = (index: any) => {
    dispatch(removePassenger(index));
  };

  const handleUpdatePassenger = (index: any, field: any, value: any) => {
